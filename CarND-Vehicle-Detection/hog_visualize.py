...
if __name__ == '__main__':
    ...
    hls_car_img = convert_color(car_img, 'RGB2HLS')
    non_car_img = mpimg.imread('non-vehicles/GTI/image1.png')
    hls_noncar_img = convert_color(non_car_img, 'RGB2HLS')
    ...
    mpimg.imsave('output_images/car.png', hls_car_img)
    ...
    mpimg.imsave('output_images/noncar.png', hls_noncar_img)
